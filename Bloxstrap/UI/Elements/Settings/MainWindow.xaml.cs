...
namespace Voidstrap.UI.Elements.Settings
{
    public partial class MainWindow : INavigationWindow
    {
        ...
        private void InitializeEasterEggs()
        {
            try
            {
                EasterEggs.Instance.Initialize(this);
                App.Logger.WriteLine("MainWindow", "Easter Eggs system initialized");
            }
            catch (Exception ex)
            {
                App.Logger.WriteLine("MainWindow", $"Failed to initialize Easter Eggs: {ex.Message}");
            }
        }
