...
{
    public partial class AddFastFlagDialog_Froststrap
    {
        // Placeholder enum - adjust based on actual Voidstrap enum
        public enum FastFlagFilterType { PlaceFilter, DataCenterFilter }
        ...
        public AddFastFlagDialog_Froststrap()
        {
            InitializeComponent();
